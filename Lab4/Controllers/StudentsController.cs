...
namespace Lab4.Controllers
{
    public class StudentsController : Controller
    {
        ...
        // POST: Students/EditMemberships/5
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> EditMemberships(int id, [Bind("Id,LastName,FirstName,EnrollmentDate")] Student student)
        {
            if (id != student.Id)
            {
                return NotFound();
